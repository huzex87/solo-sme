                ...
                {navItems.map((item) => {
                    ...
                    if (item.isFab) {
                        return (
                            ...
                            >
                                <div className={cn(
                                    "w-18 h-18 md:w-20 md:h-20 rounded-[24px] md:rounded-[28px] flex items-center justify-center border-[6px] border-slate-950 transition-all duration-500 relative overflow-hidden",
                                    isActive ? "bg-primary shadow-[0_12px_40px_rgba(245,158,11,0.4)]" : "bg-emerald-500 shadow-[0_12px_40px_rgba(16,185,129,0.4)]"
                                )}>
                    ...
                    return (
                        ...
                        >
                            ...
                            {isActive && (
                                <div className="absolute -bottom-1 w-1 h-1 rounded-full bg-primary shadow-[0_0_8px_var(--amber)]" />
                            )}
                        </Link>
                    );
                })}
