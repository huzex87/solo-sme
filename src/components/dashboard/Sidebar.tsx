...
export default function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "desktop-only h-screen flex flex-col transition-all duration-300 ease-in-out border-r border-white/5",
    ...
    >
      ...
      <div className="p-4 border-t border-white/5 flex-shrink-0 space-y-4 bg-black/10">
        <div className={cn(
          ...
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber to-amber-dk flex items-center justify-center shadow-lg flex-shrink-0">
            <span className="text-ink font-bold text-sm">{userInitial}</span>
          </div>
          {!collapsed && (
            <div className="flex-1 min-w-0">
              ...
              <div className="text-amber-md text-[9px] font-bold tracking-widest uppercase">Growth Plan</div>
            </div>
          )}
        </div>
